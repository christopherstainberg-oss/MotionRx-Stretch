...
export const APP_SEARCH_INDEX: AppSearchItem[] = [
  ...
  {
    id: "assessment-adls",
    title: "Assessment · ADLs & function",
    category: "Assessment steps",
    subcategory: "Step 2 · Function",
    keywords: [
      "adl",
    ...
    href: "/assessment",
    description: "Rate ADLs; limited function reshapes the home program",
  },
  {
    id: "assessment-clinical-symptoms",
    title: "Assessment · Clinical symptoms",
    category: "Assessment steps",
    subcategory: "Step 2 · Symptoms",
    keywords: [
      "symptoms",
      "swelling",
      "radiating",
    ...
    href: "/assessment",
    description: "Evidence-based symptoms that change routine dosing",
  },
  {
    id: "journal-adls-symptoms",
    title: "Journal · ADLs & symptoms",
    category: "Journal steps",
    subcategory: "Daily function",
    keywords: ["journal adl", "journal symptoms", "daily function", "plan adjust"],
    href: "/journal",
    description: "Log ADLs and symptoms to adjust the active routine",
  },
  {
    id: "assessment-prefs",
